...
from keras_unet_collection import losses, models, base
...
#create model
model = models.unet_3plus_2d((512, 512, 3), n_labels=3, filter_num_down=[16, 32, 64, 128],  
                             stack_num_down=2, stack_num_up=1, activation='ReLU', output_activation='Softmax',
                             batch_norm=True, pool='max', unpool=False, deep_supervision=True, backbone='EfficientNetB3', freeze_backbone=False, name='unet3plus')
