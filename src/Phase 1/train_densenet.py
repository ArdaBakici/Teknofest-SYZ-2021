...
x = layers.Dropout(top_dropout_rate, name="pre_top_dropout")(x)
x = layers.Dense(512, name="top_pre_pred")(x)
x = layers.Dropout(top_dropout_rate, name="top_dropout")(x)
x = layers.Dense(1, name="pred")(x)
outputs = layers.Activation(activation='sigmoid', dtype='float32', name="result_activ")(x)

model = keras.models.Model(inputs, outputs, name="DenseNet121")
